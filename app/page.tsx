  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-gray-50 hover:shadow-lg transition">
              <h4 className="text-2xl font-bold mb-4">Coupe de Cheveux</h4>
            ...
            <div className="p-8 bg-gray-50 hover:shadow-lg transition">
              <h4 className="text-2xl font-bold mb-4">Rasage Premium</h4>
              <p className="text-gray-600 mb-4">
            ...
            <div className="p-8 bg-gray-50 hover:shadow-lg transition">
              <h4 className="text-2xl font-bold mb-4">Soins de la Barbe</h4>
              <p className="text-gray-600 mb-4">
      ...
      <section id="about" className="py-20 bg-gray-50">
        <Container>
          <h3 className="text-4xl font-bold text-center mb-12">À Propos</h3>
      ...
      <section id="contact" className="py-20 bg-white">
        <Container className="text-center">
          <h3 className="text-4xl font-bold mb-8">Nous Contacter</h3>
